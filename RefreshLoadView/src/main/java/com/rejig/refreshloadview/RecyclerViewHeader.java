...
//    private Animation mRotateDownAnim;
    ...
    private String pullString="下拉刷新";
    private String releaseString="释放立即刷新";
    private String onString="正在加载...";
...
//        mRotateDownAnim.setFillAfter(true);
    ...
    public void setText(String pullString, String releaseString, String onString){
    ...
    public void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL://正常状态
                ...
                mHintTextView.setText(pullString);
                break;
            case STATE_READY://可以刷新状态
                if (mState != STATE_READY) {
                    mArrowImageView.clearAnimation();
//                    mArrowImageView.startAnimation(mRotateUpAnim);
                    mHintTextView.setText(releaseString);
                }
                break;
            case STATE_REFRESHING://刷新状态
                mHintTextView.setText(onString);
                break;
            default:
        }
